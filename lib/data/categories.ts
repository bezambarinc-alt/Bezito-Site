...
export const CATEGORIES: Record<string, CategoryMeta> = {
  rings: {
    ...
    heroImageUrl:
      'https://res.cloudinary.com/dlg2mou53/image/upload/f_auto,q_auto/v1790382162/Jewelry%20Images/Rings/rings-hero-copy.avif',
  },
  bands: {
    eyebrow: 'The Collection',
    title: 'Bands',
    ...
    heroImageUrl:
      'https://res.cloudinary.com/dlg2mou53/image/upload/f_auto,q_auto/v1790385586/Jewelry%20Images/Bands/bands-hero-stone-sketch.avif',
  },
  bracelets: {
    eyebrow: 'The Collection',
    title: 'Bracelets',
